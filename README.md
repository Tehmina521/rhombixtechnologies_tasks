...
This repository contains my submission for the **Rhombix Technologies Data Science Internship**.  
The task demonstrates my ability to analyze data, build models, and present insights clearly and efficiently.
